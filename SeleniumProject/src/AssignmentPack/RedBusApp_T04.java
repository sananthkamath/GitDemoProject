...
public class RedBusApp_T04
{
	WebDriver driver = null;
	@Test public void EmailSMS() throws InterruptedException {
		...
		try
		{
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='hmb']/div[2]/ul/li[5]")));
			WebElement showMyTicket = driver.findElement(By.xpath("//*[@id='hmb']/div[2]/ul/li[5]"));
			showMyTicket.click();
		}
		catch(NoSuchElementException e)
		{
		...
		{
			System.out.println("Check only your current booking status, if not re-check your ticket number or email id and then click submit.");
		}
